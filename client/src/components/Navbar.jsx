  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        sticky
          ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all"
          : ""
      }`}
    >
      <div className="navbar bg-white" style={{ maxWidth: "90%" }}>
        <div className="navbar-start">
          ...
          <a className="text-2xl cursor-pointer" style={{ fontWeight: "bold" }}>
